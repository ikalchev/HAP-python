...
class AccessoryDriver(object):
   ...
   def __init__(self, accessory, advertiser, port, address=None,
                persist_file="accessory.pickle"):
      """
      @param accessory: The Accessory to be managed by this driver.
      @type accessory: Accessory
      
      @param advertiser: A Zeroconf advertiser, which will advertise the accessory.
      @type advertiser: Zeroconf
   ...
   def start(self):
      ...
      - Start the accessory's run method.
      ...
      self.http_server_thread.daemon = False
      ...
      accessory_thread = threading.Thread(target=self.accessory.run, daemon=True)
